...
export const routes: Routes = [
  { path: 'login', loadComponent: () => import('./pages/login/login.component').then(m => m.LoginComponent) },
  {
    ...
    children: [
      ...
      { path: 'commandes/nouvelle', loadComponent: () => import('./pages/commande-form/commande-form.component').then(m => m.CommandeFormComponent) },
      { path: 'commandes/:id/modifier', loadComponent: () => import('./pages/commande-form/commande-form.component').then(m => m.CommandeFormComponent) },
